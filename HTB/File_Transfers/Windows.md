...
After the server is setup, we can transfer files using the pre installed FTP client fromw windows or powershell net.webclient
Using powershell:
```powershell
...
echo <Base 64 string> | base64 -d > hosts
